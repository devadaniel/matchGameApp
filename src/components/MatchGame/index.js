...
import ThumbnailItems from '../TumbnailItems'
...
class MatchGame extends Component {
  ...
  onClickThumbnail = thumbnail => {
    ...
    const imageValue = imagesList.filter(
      eachImage => eachImage.thumbnailUrl === thumbnail,
    )
  ...
  onClickIsActive = activeId => {
    this.setState({isActiveTabId: activeId})
  }

  getFilterImageList = () => {
    const {isActiveTabId} = this.state
    const filterImageList = imagesList.filter(
      eachThumb => eachThumb.category === isActiveTabId,
    )
  ...
  render() {
    const {isActiveTabId, imgUrl, timer, score, isTrue} = this.state
    const filterImageList = this.getFilterImageList()
    return (
      <div className="match-game-container">
        <nav className="header-container">
          ...
          />
          <div className="score-count-time-container">
        ...
        {isTrue ? (
          <div className="game-score-container">
            <div className="score-card-image-container">
              ...
              <button
                ...
                type="button"
                onClick={this.onClickRestartBtn}
              >
                <img
          ...
          <div className="tab-item-thumbnail-container">
            ...
            <ul className="tab-item-container">
              {tabsList.map(eachTabItem => (
                <TabItems
                  ...
                  activeTabId={this.onClickIsActive}
                />
              ))}
            </ul>
            <ul className="image-list-item-container">
